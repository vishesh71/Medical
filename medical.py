...
def Home():
   ...
   # root.geometry("1024x520")
    ...
    Title.pack(pady=10)
    Label(text = "MEDICAL INVENTRY SYSTEM",fg="blue" , width = "300", height = "2", font = ("bold", 15)).pack()
...
def AddNewForm():
    ...
    lbl_text = Label(TopAddNew, text="Add New Product",bg="black",fg="red", font=('arial', 18), width=600)
    lbl_text.pack(fill=X)
